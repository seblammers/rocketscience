library(holepunch)
write_compendium_description(package = "The Rocket Science Compendium", 
                             description = "This is to test if {holepunch} is truly magical.")
# to write a description, with dependencies listed 
# It's good practice to now go fill in the placeholder text.

write_dockerfile(maintainer = "Sebastian") 
